...
public class Modifiers {
	...
	public static final Function<List<Object>, Function> default1 = objects -> {
	...
	public static final Function<List<Object>, Function> trim = objects -> (Function<FunctionKeeper, Object>) (
			wrapper) -> {
	...
	public static final Function<List<Object>, Function> to_lc = objects -> (Function<FunctionKeeper, Object>) (
			wrapper) -> {
		if (LIVRUtils.isNoValue(wrapper.getValue()) || wrapper.getValue().getClass() == JSONObject.class)
			return "";
	...
	public static final Function<List<Object>, Function> to_uc = objects -> (Function<FunctionKeeper, Object>) (
			wrapper) -> {
		if (LIVRUtils.isNoValue(wrapper.getValue()) || wrapper.getValue().getClass() == JSONObject.class)
			return "";
	...
	public static final Function<List<Object>, Function> remove = objects -> {
	...
	public static final Function<List<Object>, Function> leave_only = objects -> {
		String escaped = Pattern.quote(objects.get(0) + "");
